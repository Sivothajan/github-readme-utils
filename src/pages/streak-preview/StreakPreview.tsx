  ...
  return (
    <div className="min-h-screen w-full font-sans text-slate-800 dark:text-slate-100 transition-colors duration-300 flex flex-col">
      <div className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
        ...
        <PageHeader
          title="Streak Config"
          description="Customize your contribution streak card."
        />

        {/* --- Options Section --- */}
        <div
          id="optionsSection"
          className="grid grid-cols-1 xl:grid-cols-12 gap-8 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 transition-colors duration-300 mb-8"
        >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <select
                    id="date_format"
                    value={
                      optionsTypeBoolean ? '' : (options.date_format ?? '')
                    }
                    onChange={(e) =>
                      setOptions({
                        ...options,
                ...
                <div className="flex items-center pt-6">
                  ...
                  >
                    <input
                      ...
                      type="checkbox"
                      checked={
                        optionsTypeBoolean ? false : options.short_numbers
                      }
                      onChange={(e) =>
                        setOptions({
                          ...options,
